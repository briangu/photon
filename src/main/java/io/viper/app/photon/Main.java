  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      ...
      if (args.length >= 3)
      {
        ...
        photoServer = PhotoServer.createWithS3("bguarrac-md.linkedin.biz", 3000, awsId, awsSecret, bucketName, staticFileRoot);
      }
      else
      {
        new File(staticFileRoot).mkdir();
        photoServer = PhotoServer.create("bguarrac-md.linkedin.biz", 3000, staticFileRoot);
      }
    }
